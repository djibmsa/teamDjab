...
const questions = [
  {
    ...
    image: "/assets/pictures/stern.webp",
  },
  {
    question:
    ...
    correct: "Canada",
    image: "/assets/pictures/vince-carter-dunk.webp",
  },
  {
  ...
  {
    question:
      "Combien y a-t-il de matchs au total sur une saison régulière en NBA ?",
    answer: ["42", "54", "70", "82"],
    correct: "82",
  },
  {
  ...
  {
    question:
      "Comment se nomment les matchs éliminatoires de NBA organisés en quatre tours ?",
  ...
  {
    question:
      "Comment se nomme le stade dans lequel évolue l'équipe de basket des New York Knicks ?",
    answer: [
      "Staples Center",
      "Madison Square",
      "Rockefeller Center",
  ...
  {
    question:
      "Quel joueur de basket détient le record de titres de champion NBA ?",
  ...
  {
    question:
      "Quelle est la première équipe NBA à qui l'on donne le nom de: BAD BOYS ?",
    answer: [
      "New York Knicks",
      "Boston Celtics",
      "Detroit Pistons",
  ...
  {
    question:
      "Qui est considéré comme le meilleur meneur de l'histoire de la NBA ?",
...
function showQuestion(question) {
  ...
  // Changer l'image associée à la question si elle existe
  if (question.image) {
    img.src = question.image; // Change la source de l'image
  } else {
    img.src = ""; // Si pas d'image, vous pouvez cacher l'image ou utiliser une image par défaut
  }
}
...
function changeImage() {
  // Sélectionnez l'image par son id et changez la source
  const img = document.getElementById("quizImage");
  img.src = "/assets/pictures/new_image.webp"; // Remplacez par le chemin de la nouvelle image
}
